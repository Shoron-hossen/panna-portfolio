...
function populateEducationEntries() {
    ...
    container.innerHTML = items.map(function(item, i) {
        ...
        var logoHtml = item.logo
            ? '<img src="' + item.logo + '" alt="' + (item.institution || '') + '" class="w-10 h-10 md:w-12 md:h-12 object-contain rounded-full flex-shrink-0 border border-outline-variant" onerror="this.style.display=\'none\'">'
            : '';
